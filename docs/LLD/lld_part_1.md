...
classDiagram
    ...
    class ShoppingCartController {
        ...
        +addToCart(Long productId, Integer quantity, Boolean isSubscription) ResponseEntity~CartItem~
        +viewCart(Long customerId) ResponseEntity~ShoppingCart~
        +updateCartItemQuantity(Long cartItemId, Integer quantity) ResponseEntity~CartItem~
        +removeFromCart(Long cartItemId) ResponseEntity~Void~
    ...
    class ShoppingCartService {
        ...
        -ProductRepository productRepository
        +addProductToCart(Long customerId, Long productId, Integer quantity, Boolean isSubscription) CartItem
    ...
    class CartItemRepository {
        ...
        +deleteCartItemById(Long id) void
    }
...
erDiagram
    ...
    CART_ITEMS {
        ...
        BOOLEAN is_subscription "DEFAULT FALSE"
        TIMESTAMP created_at "NOT NULL, DEFAULT CURRENT_TIMESTAMP"
        TIMESTAMP updated_at "NOT NULL, DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP"
    }
