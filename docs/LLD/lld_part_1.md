...
classDiagram
    ...
    class CartController {
        ...
        +addToCart(Long productId, Long customerId) ResponseEntity~CartItem~
    ...
    class CartService {
        ...
        -ProductRepository productRepository
        +addToCart(Long productId, Long customerId) CartItem
        +viewCart(Long customerId) ShoppingCart
        +updateCartItemQuantity(Long itemId, Integer quantity) CartItem
        +removeCartItem(Long itemId) void
        +recalculateCartTotals(Long cartId) void
    }
    ...
    class CartRepository {
        ...
        +deleteCartItemById(Long itemId) void
    }
