...
classDiagram
    ...
    class CartController {
        ...
        +updateItemQuantity(Long itemId, Integer quantity) ResponseEntity~CartItem~
        +removeItem(Long itemId) ResponseEntity~Void~
    }
    ...
    class CartService {
        ...
        +calculateTotals(ShoppingCart cart) void
    }
