...
classDiagram
    ...
    class CartController {
        ...
        +addToCart(Long customerId, CartItemRequest request) ResponseEntity~Cart~
        +updateCartItem(Long itemId, Integer quantity) ResponseEntity~Cart~
    ...
    class CartService {
        ...
        -ProductRepository productRepository
        +getCart(Long customerId) Cart
        +addToCart(Long customerId, Long productId, Integer quantity, Boolean isSubscription) Cart
        +updateQuantity(Long itemId, Integer quantity) Cart
        +removeFromCart(Long itemId) Cart
