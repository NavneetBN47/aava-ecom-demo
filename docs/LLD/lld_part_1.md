...
classDiagram
    ...
    class ShoppingCartController {
        ...
        +updateQuantity(Long itemId, UpdateQuantityRequest request) ResponseEntity~CartItem~
        +removeFromCart(Long itemId) ResponseEntity~Cart~
    ...
    class ShoppingCartService {
        ...
        -ProductRepository productRepository
        +addProductToCart(Long productId, Boolean isSubscription) CartItem
...
erDiagram
    PRODUCTS {
        ...
        INTEGER minimum_procurement_threshold "DEFAULT 1"
