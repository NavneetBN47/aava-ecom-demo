...
classDiagram
    ...
    class CartService {
        ...
        +addItemToCart(Long customerId, Long productId, Boolean isSubscription) CartItem
    ...
    class CartItem {
        ...
        +setProductName(String name) void
        +getQuantity() Integer
        ...
        +setMinimumThreshold(Integer threshold) void
    }
...
erDiagram
    ...
    CART_ITEMS {
        ...
        INTEGER minimum_threshold "NULLABLE"
    }
