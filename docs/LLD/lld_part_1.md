...
erDiagram
    ...
    ORDERS {
        BIGINT order_id PK "AUTO_INCREMENT, NOT NULL"
        BIGINT customer_id "NOT NULL"
        BIGINT cart_id FK "NOT NULL"
        VARCHAR order_status "NOT NULL, MAX_LENGTH(50)"
        DECIMAL total_amount "NOT NULL, PRECISION(10,2)"
        VARCHAR payment_method "MAX_LENGTH(50)"
        VARCHAR payment_status "MAX_LENGTH(50)"
        VARCHAR shipping_address "NOT NULL"
        VARCHAR tracking_number "MAX_LENGTH(100)"
        TIMESTAMP order_date "NOT NULL, DEFAULT CURRENT_TIMESTAMP"
        TIMESTAMP updated_at "NOT NULL, DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP"
    }
    
    PROMOTIONS {
        BIGINT promotion_id PK "AUTO_INCREMENT, NOT NULL"
        VARCHAR code "UNIQUE, NOT NULL, MAX_LENGTH(50)"
        VARCHAR description "MAX_LENGTH(255)"
    ...
    NOTIFICATIONS {
        BIGINT notification_id PK "AUTO_INCREMENT, NOT NULL"
        BIGINT customer_id "NOT NULL"
        VARCHAR notification_type "NOT NULL, MAX_LENGTH(50)"
        VARCHAR message "NOT NULL, TEXT"
